...
public interface IFamilyService
{
    ...
    Task DemoteToMemberAsync(Guid familyId, string targetUserId, string actingUserId, CancellationToken cancellationToken = default);
    Task RemoveMemberAsync(Guid familyId, string targetUserId, string actingUserId, CancellationToken cancellationToken = default);
    Task LeaveFamilyAsync(string userId, CancellationToken cancellationToken = default);
